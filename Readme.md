...
+-- alpine:3.7 (3.962 MB)                                 ====> official image
    |
    +-- node:10.3.0-alpine (64.64 MB)                     ====> official image
    |   |
    |   +-- anacha/ng:6.1.0-beta.0-alpine (108 MB)        ====> optional ***
    |   `-- anacha/ng:6.0.7-alpine (108 MB)               ====> base images
    |       |
    |      (+)-- anacha/ng-testplat:6.0.7-alpine (285 MB) ====> this project ***
    |       |
