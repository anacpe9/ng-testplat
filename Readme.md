...
+-- alpine:3.8 (4.41 MB)                                  ====> official image
    ...
    |   `-- anacha/ng:7.3.2-alpine (331 MB)               ====> base images
    |       |
    |      (+)-- anacha/ng-testplat:7.3.2-alpine (285 MB) ====> this project ***
    |       |
...
| ------------------------ | --------------- | ------------------- | ------------ |
| ng-testplat:7.3.2-alpine | ng:7.3.2-alpine | node:11.10.0-alpine | alpine:3.8   |
