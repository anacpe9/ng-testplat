...
+-- alpine:3.8 (4.41 MB)                                  ====> official image
    |
    +-- node:11.3.0-alpine (71.40 MB)                     ====> official image
    |   |
    |   +-- anacha/ng:7.2.0-beta.0-alpine (331 MB)          ====> optional ***
    |   `-- anacha/ng:7.1.1-alpine (331 MB)               ====> base images
    |       |
    |      (+)-- anacha/ng-testplat:7.1.1-alpine (285 MB) ====> this project ***
    |       |
