...
+-- alpine:3.8 (4.41 MB)                                  ====> official image
    |
    +-- node:10.12.0-alpine (71.40 MB)                    ====> official image
    |   |
    |   +-- anacha/ng:7.0.0-rc.3-alpine (331 MB)          ====> optional ***
    |   `-- anacha/ng:6.2.5-alpine (331 MB)               ====> base images
    |       |
    |      (+)-- anacha/ng-testplat:6.2.5-alpine (285 MB) ====> this project ***
    |       |
...
| ------------------------ | --------------- | ------------------- | ------------ |
| ng-testplat:6.2.5-alpine | ng:6.2.5-alpine | node:10.11.0-alpine | alpine:3.8   |
